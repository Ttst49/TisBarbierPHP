<div class="prestationsCards">
    <div class="cartePrestation">
        <div class="title">Barbe <img class="icon" src="img/beard.png" alt="logo barbe"></div>
    ...
    <div class="cartePrestation">
        <div class="title">Cheveux <img class="icon" src="img/hair.png" alt="Logo cheveux"></div>
        <div class="presentationText">
    ...
    <div class="cartePrestation premium">
        <div class="title premiumTitle">La totale <img class="icon" src="img/laTotale.png" alt="logo La Totale"></div>
